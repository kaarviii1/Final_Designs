...
module accelerator_mem #(
    ...
    always @(posedge clk) begin
        if (wen_b0[0]) begin
            mem_b0[addr][ 7: 0] <= wdata_b0[ 7: 0];
        end
        if (wen_b0[1]) begin
            mem_b0[addr][15: 8] <= wdata_b0[15: 8];
        end
        if (wen_b0[2]) begin
            mem_b0[addr][23:16] <= wdata_b0[23:16];
        end
        if (wen_b0[3]) begin
            mem_b0[addr][31:24] <= wdata_b0[31:24];
        end
    end
    ...
    always @(posedge clk) begin
        if (wen_b1[0]) begin
            mem_b1[addr][ 7: 0] <= wdata_b1[ 7: 0];
        end
        if (wen_b1[1]) begin
            mem_b1[addr][15: 8] <= wdata_b1[15: 8];
        end
        if (wen_b1[2]) begin
            mem_b1[addr][23:16] <= wdata_b1[23:16];
        end
        if (wen_b1[3]) begin
            mem_b1[addr][31:24] <= wdata_b1[31:24];
        end
    end
endmodule
