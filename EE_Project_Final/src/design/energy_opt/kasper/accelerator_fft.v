module accelerator_fft #(
  ...
  localparam READ_W_M = 3'd1;
  localparam BUTTERFLY_READ_U = 3'd2;
  localparam BUTTERFLY_READ_V = 3'd3;
  localparam BUTTERFLY_COMPUTE = 3'd4;
  localparam BUTTERFLY_WRITE_E = 3'd5;
  localparam BUTTERFLY_WRITE_O = 3'd6;
  ...
  assign stage_loop_finished = (stage == num_fft_stages);
  assign next_k = k + 1;
