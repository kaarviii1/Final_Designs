...
#set_dont_touch [get_nets soc/*]            false
#set_dont_touch [get_nets soc/cpu/*]        false
#set_dont_touch [get_nets soc/simpleuart/*] false
#set_dont_touch [get_nets soc/spimemio/*]   false
#set_dont_touch [get_nets soc/memory/*]     false
