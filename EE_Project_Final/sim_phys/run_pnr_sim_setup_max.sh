...
# Compile libraries
vlog /data/Cadence/gpdk045_v60/gsclib045_all_v4.7/gsclib045_hvt/verilog/slow_vdd1v0_basicCells_hvt.v
...
vsim testbench -voptargs=+acc -c -do ./scripts/run_vcd_setup.cmd -t 1ns \
