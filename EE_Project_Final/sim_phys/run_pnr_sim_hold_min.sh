...
# Compile libraries
vlog /data/Cadence/gpdk045_v60/gsclib045_all_v4.7/gsclib045_hvt/verilog/fast_vdd1v2_basicCells_hvt.v
...
vsim testbench -voptargs=+acc -c -do ./scripts/run_vcd_hold.cmd -t 1ns \
